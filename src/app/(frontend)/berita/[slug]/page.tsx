  ...
  return (
    <>
      <style>{`
        ...
        .article-excerpt-box {
          background: var(--blue-50); border-left: 5px solid var(--blue-400);
        ...
        .article-gallery-grid { display: grid; grid-template-columns: repeat(3, 1fr); gap: .75rem; }
        ...
        .sidebar-post { display: flex; gap: .75rem; text-decoration: none; transition: opacity .2s; }
        ...
        .sidebar-post-title {
          font-size: .82rem; color: var(--gray-900); font-weight: 600; line-height: 1.4;
